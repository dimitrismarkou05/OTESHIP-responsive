  ...
  if (isGuidePage) {
    return (
      ...
      <div className="flex flex-col min-h-screen bg-[#F8FAFC] dark:bg-[#0b101a] transition-colors duration-200">
        ...
        >
          <div className="no-scale flex justify-end p-3 bg-white dark:bg-(--color-bg-dark-text) border-b border-(--color-light3-text)/40 dark:border-slate-700/60 shrink-0">
            <button
              onClick={() => setIsSidebarOpen(false)}
